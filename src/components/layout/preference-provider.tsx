...
const copy = {
  tr: {
    ...
    heroText: "10 odalı butik otel. Yarım pansiyon. Deniz karşınızda, kahvaltı dahil.",
    heroRooms: "10 oda",
    ...
    roomsText: "10 odalı butik yapı. Her oda sade, aydınlık ve net bilgilerle hazır.",
  ...
  en: {
    ...
    heroText: "A 10-room boutique hotel. Half board. The beach is right across the road.",
    heroRooms: "10 rooms",
    ...
    roomsText: "A boutique 10-room setting with clear, calm room details.",
  ...
  de: {
    ...
    heroText: "Ein Boutique-Hotel mit 10 Zimmern. Halbpension. Der Strand ist direkt gegenüber.",
    heroRooms: "10 Zimmer",
    ...
    roomsText: "Ein Boutique-Haus mit 10 Zimmern und klaren, ruhigen Details.",
